@extends('layout.home')
@section('info')
    <title>peachsuger的博客展示页</title>
    <meta name="keywords" content="peachsuger的博客" />
    <meta name="description" content="peachsuger的博客" />
@endsection
@section('content')
    <div class="banner">
        <section class="box">
            ...
            <div class="avatar"><a href="#"><span>peachsuger</span></a> </div>
        </section>
    </div>
    <div class="template">
        <div class="box">
